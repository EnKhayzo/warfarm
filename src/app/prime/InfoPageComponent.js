      ...
      <div className='sized-content v-flex flex-center' style={{ gap: '30px' }}>
        <div className="sized-content v-flex flex-center">
            ...
            <div className="sized-content v-flex">
              ...
              <span className="sized-content h-flex" style={{ whiteSpace: 'pre', alignItems: 'center' }}><img className="icon-default-filter" style={{ width: '20px', height: '20px' }}    src={`${com.getBaseEnvPath().basePath}/icons/eye.svg`}/> = Eye/Obtained button, lets you set the farming status for the components of an object (item, relic or component). The number indicates how many components you have in total.</span>
              ...
              <span className="sized-content h-flex" style={{ whiteSpace: 'pre', alignItems: 'center' }}><img className="icon-default-filter" style={{ width: '20px', height: '20px' }}    src={`${com.getBaseEnvPath().basePath}/icons/owned.svg`}/> = Owned Button, applies to relics and lets you set how many you have (divided by refinement level).</span>
              </div>
          </div>
          <div className="sized-content v-flex flex-center">
